...
void TestThreads() {
	...
	if (pthread_create( &t1, nullptr, ThreadFunc2, reinterpret_cast<void *>(1) ) != 0) {
	...
	if (pthread_create( &t2, nullptr, ThreadFunc2, reinterpret_cast<void *>(2) ) != 0) {
